...
app.use(function (req, res, next) {
  ...
  const allowedOrigins = ['https://editor.swagger.io', 'https://hoppscotch.io','http://localhost:8080','http://weatherservice.fly.dev/'];
...
app.get('/v1/weather',(req,res) => {
  ...
  if (!authHeaderToken){
    res.send("You need to request with authorization token")
  }
